...
const envSchema = zod_1.z.object({
    ...
    DIRECT_URL: zod_1.z.string().min(1, "DIRECT_URL is required (migrations)"),
    ...
    PUBLIC_WEB_URL: zod_1.z.string().url().default("http://localhost:3000"),
    ...
    JWT_EXPIRES_IN: zod_1.z.string().min(1).default("12h"),
 ...
 */
function requireEnv(key, reason) {
